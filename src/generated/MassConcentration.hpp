...
{
    enum class MassConcentrationUnit : std::uint16_t
    {
    ...
    public:
        constexpr explicit MassConcentration(
            double value,
            MassConcentrationUnit unit = MassConcentrationUnit::KilogramsPerCubicMeter)
        ...
        [[nodiscard]] constexpr double value(MassConcentrationUnit unit) const
        {
            return convert_from_base(unit);
        }

        [[nodiscard]] constexpr MassConcentration operator+(MassConcentration other) const noexcept
        {
        ...
        [[nodiscard]] constexpr MassConcentration operator*(double scalar) const noexcept
        {
        ...
        [[nodiscard]] constexpr bool operator==(MassConcentration other) const noexcept
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_grams_per_cubic_millimeter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_kilograms_per_cubic_millimeter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_grams_per_cubic_centimeter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_kilograms_per_cubic_centimeter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_grams_per_cubic_meter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_kilograms_per_cubic_meter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_milligrams_per_cubic_meter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_micrograms_per_cubic_meter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::MicrogramsPerCubicMeter);
        }


        [[nodiscard]] constexpr double grams_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::GramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_grams_per_microliter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::GramsPerMicroliter);
        }


        [[nodiscard]] constexpr double picograms_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::PicogramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_picograms_per_microliter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::PicogramsPerMicroliter);
        }


        [[nodiscard]] constexpr double nanograms_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::NanogramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_nanograms_per_microliter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::NanogramsPerMicroliter);
        }


        [[nodiscard]] constexpr double micrograms_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::MicrogramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_micrograms_per_microliter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::MicrogramsPerMicroliter);
        }


        [[nodiscard]] constexpr double milligrams_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::MilligramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_milligrams_per_microliter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::MilligramsPerMicroliter);
        }


        [[nodiscard]] constexpr double centigrams_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::CentigramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_centigrams_per_microliter(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::CentigramsPerMicroliter);
        }


        [[nodiscard]] constexpr double decigrams_per_microliter() const
        {
            return convert_from_base(MassConcentrationUnit::DecigramsPerMicroliter);
        }

        [[nodiscard]] static constexpr MassConcentration from_decigrams_per_microliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_grams_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_picograms_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_nanograms_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_micrograms_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_milligrams_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_centigrams_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_decigrams_per_milliliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_grams_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_picograms_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_nanograms_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_micrograms_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_milligrams_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_centigrams_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_decigrams_per_deciliter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_grams_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_picograms_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_nanograms_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_micrograms_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_milligrams_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_centigrams_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_decigrams_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_kilograms_per_liter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_tonnes_per_cubic_millimeter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_tonnes_per_cubic_centimeter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_tonnes_per_cubic_meter(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_pounds_per_cubic_inch(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_kilopounds_per_cubic_inch(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_pounds_per_cubic_foot(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_kilopounds_per_cubic_foot(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_slugs_per_cubic_foot(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_pounds_per_u_s_gallon(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::PoundsPerUSGallon);
        }


        [[nodiscard]] constexpr double ounces_per_u_s_gallon() const
        {
            return convert_from_base(MassConcentrationUnit::OuncesPerUSGallon);
        }

        [[nodiscard]] static constexpr MassConcentration from_ounces_per_u_s_gallon(double value)
        {
            return MassConcentration(value, MassConcentrationUnit::OuncesPerUSGallon);
        }


        [[nodiscard]] constexpr double ounces_per_imperial_gallon() const
        {
            return convert_from_base(MassConcentrationUnit::OuncesPerImperialGallon);
        }

        [[nodiscard]] static constexpr MassConcentration from_ounces_per_imperial_gallon(double value)
        {
        ...
        [[nodiscard]] static constexpr MassConcentration from_pounds_per_imperial_gallon(double value)
        {
    ...
    private:
        [[nodiscard]] static constexpr double convert_to_base(double value, MassConcentrationUnit unit)
        {
            switch (unit)
            {
        ...
        [[nodiscard]] constexpr double convert_from_base(MassConcentrationUnit unit) const
        {
            switch (unit)
            {
            ...
            case MassConcentrationUnit::OuncesPerUSGallon:
                return value_ * 0.003785411784 / 0.028349523125;

            case MassConcentrationUnit::OuncesPerImperialGallon:
                return value_ * 0.00454609 / 0.028349523125;
