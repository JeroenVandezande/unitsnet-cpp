...
{
    enum class MassMomentOfInertiaUnit : std::uint16_t
    {
        GramSquareMeters,
    ...
    public:
        constexpr explicit MassMomentOfInertia(
            double value,
            MassMomentOfInertiaUnit unit = MassMomentOfInertiaUnit::KilogramSquareMeters)
        ...
        [[nodiscard]] constexpr double value(MassMomentOfInertiaUnit unit) const
        {
            return convert_from_base(unit);
        }

        [[nodiscard]] constexpr MassMomentOfInertia operator+(MassMomentOfInertia other) const noexcept
        {
        ...
        [[nodiscard]] constexpr MassMomentOfInertia operator*(double scalar) const noexcept
        {
        ...
        [[nodiscard]] constexpr bool operator==(MassMomentOfInertia other) const noexcept
        {
    ...
    private:
        [[nodiscard]] static constexpr double convert_to_base(double value, MassMomentOfInertiaUnit unit)
        {
            switch (unit)
            {
        ...
        [[nodiscard]] constexpr double convert_from_base(MassMomentOfInertiaUnit unit) const
        {
            switch (unit)
            {
            ...
            case MassMomentOfInertiaUnit::MilligramSquareCentimeters:
                return (value_ * 1e7) / 1e-3;

            case MassMomentOfInertiaUnit::KilogramSquareCentimeters:
                return (value_ * 1e7) / 1e3;

            case MassMomentOfInertiaUnit::GramSquareMillimeters:
                return value_ * 1e9;

            case MassMomentOfInertiaUnit::MilligramSquareMillimeters:
                return (value_ * 1e9) / 1e-3;

            case MassMomentOfInertiaUnit::KilogramSquareMillimeters:
                return (value_ * 1e9) / 1e3;
            ...
            case MassMomentOfInertiaUnit::MegatonneSquareDecimeters:
                return (value_ * 1e-1) / 1e6;

            case MassMomentOfInertiaUnit::TonneSquareCentimeters:
                return value_ * 1e1;

            case MassMomentOfInertiaUnit::KilotonneSquareCentimeters:
                return (value_ * 1e1) / 1e3;

            case MassMomentOfInertiaUnit::MegatonneSquareCentimeters:
                return (value_ * 1e1) / 1e6;
