...
{
    enum class DensityUnit : std::uint16_t
    {
    ...
    public:
        constexpr explicit Density(
            double value,
            DensityUnit unit = DensityUnit::KilogramsPerCubicMeter)
        ...
        [[nodiscard]] constexpr double value(DensityUnit unit) const
        {
            return convert_from_base(unit);
        }

        [[nodiscard]] constexpr Density operator+(Density other) const noexcept
        {
        ...
        [[nodiscard]] constexpr Density operator*(double scalar) const noexcept
        {
        ...
        [[nodiscard]] constexpr bool operator==(Density other) const noexcept
        {
        ...
        [[nodiscard]] constexpr double grams_per_cubic_millimeter() const
        {
            return convert_from_base(DensityUnit::GramsPerCubicMillimeter);
        }

        [[nodiscard]] static constexpr Density from_grams_per_cubic_millimeter(double value)
        {
            return Density(value, DensityUnit::GramsPerCubicMillimeter);
        }


        [[nodiscard]] constexpr double kilograms_per_cubic_millimeter() const
        {
            return convert_from_base(DensityUnit::KilogramsPerCubicMillimeter);
        }

        [[nodiscard]] static constexpr Density from_kilograms_per_cubic_millimeter(double value)
        {
            return Density(value, DensityUnit::KilogramsPerCubicMillimeter);
        }


        [[nodiscard]] constexpr double grams_per_cubic_centimeter() const
        {
            return convert_from_base(DensityUnit::GramsPerCubicCentimeter);
        }

        [[nodiscard]] static constexpr Density from_grams_per_cubic_centimeter(double value)
        {
            return Density(value, DensityUnit::GramsPerCubicCentimeter);
        }


        [[nodiscard]] constexpr double kilograms_per_cubic_centimeter() const
        {
            return convert_from_base(DensityUnit::KilogramsPerCubicCentimeter);
        }

        [[nodiscard]] static constexpr Density from_kilograms_per_cubic_centimeter(double value)
        {
            return Density(value, DensityUnit::KilogramsPerCubicCentimeter);
        }


        [[nodiscard]] constexpr double grams_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::GramsPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_grams_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::GramsPerCubicMeter);
        }


        [[nodiscard]] constexpr double kilograms_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::KilogramsPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_kilograms_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::KilogramsPerCubicMeter);
        }


        [[nodiscard]] constexpr double milligrams_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::MilligramsPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_milligrams_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::MilligramsPerCubicMeter);
        }


        [[nodiscard]] constexpr double micrograms_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::MicrogramsPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_micrograms_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::MicrogramsPerCubicMeter);
        }


        [[nodiscard]] constexpr double pounds_per_cubic_inch() const
        {
            return convert_from_base(DensityUnit::PoundsPerCubicInch);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_cubic_inch(double value)
        {
            return Density(value, DensityUnit::PoundsPerCubicInch);
        }


        [[nodiscard]] constexpr double kilopounds_per_cubic_inch() const
        {
            return convert_from_base(DensityUnit::KilopoundsPerCubicInch);
        }

        [[nodiscard]] static constexpr Density from_kilopounds_per_cubic_inch(double value)
        {
            return Density(value, DensityUnit::KilopoundsPerCubicInch);
        }


        [[nodiscard]] constexpr double pounds_per_cubic_foot() const
        {
            return convert_from_base(DensityUnit::PoundsPerCubicFoot);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_cubic_foot(double value)
        {
            return Density(value, DensityUnit::PoundsPerCubicFoot);
        }


        [[nodiscard]] constexpr double kilopounds_per_cubic_foot() const
        {
            return convert_from_base(DensityUnit::KilopoundsPerCubicFoot);
        }

        [[nodiscard]] static constexpr Density from_kilopounds_per_cubic_foot(double value)
        {
            return Density(value, DensityUnit::KilopoundsPerCubicFoot);
        }


        [[nodiscard]] constexpr double pounds_per_cubic_yard() const
        {
            return convert_from_base(DensityUnit::PoundsPerCubicYard);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_cubic_yard(double value)
        {
            return Density(value, DensityUnit::PoundsPerCubicYard);
        }


        [[nodiscard]] constexpr double kilopounds_per_cubic_yard() const
        {
            return convert_from_base(DensityUnit::KilopoundsPerCubicYard);
        }

        [[nodiscard]] static constexpr Density from_kilopounds_per_cubic_yard(double value)
        {
            return Density(value, DensityUnit::KilopoundsPerCubicYard);
        }


        [[nodiscard]] constexpr double tonnes_per_cubic_millimeter() const
        {
            return convert_from_base(DensityUnit::TonnesPerCubicMillimeter);
        }

        [[nodiscard]] static constexpr Density from_tonnes_per_cubic_millimeter(double value)
        {
            return Density(value, DensityUnit::TonnesPerCubicMillimeter);
        }


        [[nodiscard]] constexpr double tonnes_per_cubic_centimeter() const
        {
            return convert_from_base(DensityUnit::TonnesPerCubicCentimeter);
        }

        [[nodiscard]] static constexpr Density from_tonnes_per_cubic_centimeter(double value)
        {
            return Density(value, DensityUnit::TonnesPerCubicCentimeter);
        }


        [[nodiscard]] constexpr double tonnes_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::TonnesPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_tonnes_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::TonnesPerCubicMeter);
        }


        [[nodiscard]] constexpr double slugs_per_cubic_foot() const
        {
            return convert_from_base(DensityUnit::SlugsPerCubicFoot);
        }

        [[nodiscard]] static constexpr Density from_slugs_per_cubic_foot(double value)
        {
            return Density(value, DensityUnit::SlugsPerCubicFoot);
        }


        [[nodiscard]] constexpr double grams_per_liter() const
        {
            return convert_from_base(DensityUnit::GramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_grams_per_liter(double value)
        {
            return Density(value, DensityUnit::GramsPerLiter);
        }


        [[nodiscard]] constexpr double femtograms_per_liter() const
        {
            return convert_from_base(DensityUnit::FemtogramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_femtograms_per_liter(double value)
        {
            return Density(value, DensityUnit::FemtogramsPerLiter);
        }


        [[nodiscard]] constexpr double picograms_per_liter() const
        {
            return convert_from_base(DensityUnit::PicogramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_picograms_per_liter(double value)
        {
            return Density(value, DensityUnit::PicogramsPerLiter);
        }


        [[nodiscard]] constexpr double nanograms_per_liter() const
        {
            return convert_from_base(DensityUnit::NanogramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_nanograms_per_liter(double value)
        {
            return Density(value, DensityUnit::NanogramsPerLiter);
        }


        [[nodiscard]] constexpr double micrograms_per_liter() const
        {
            return convert_from_base(DensityUnit::MicrogramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_micrograms_per_liter(double value)
        {
            return Density(value, DensityUnit::MicrogramsPerLiter);
        }


        [[nodiscard]] constexpr double milligrams_per_liter() const
        {
            return convert_from_base(DensityUnit::MilligramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_milligrams_per_liter(double value)
        {
            return Density(value, DensityUnit::MilligramsPerLiter);
        }


        [[nodiscard]] constexpr double centigrams_per_liter() const
        {
            return convert_from_base(DensityUnit::CentigramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_centigrams_per_liter(double value)
        {
            return Density(value, DensityUnit::CentigramsPerLiter);
        }


        [[nodiscard]] constexpr double decigrams_per_liter() const
        {
            return convert_from_base(DensityUnit::DecigramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_decigrams_per_liter(double value)
        {
            return Density(value, DensityUnit::DecigramsPerLiter);
        }


        [[nodiscard]] constexpr double grams_per_deciliter() const
        {
            return convert_from_base(DensityUnit::GramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_grams_per_deciliter(double value)
        {
            return Density(value, DensityUnit::GramsPerDeciliter);
        }


        [[nodiscard]] constexpr double femtograms_per_deciliter() const
        {
            return convert_from_base(DensityUnit::FemtogramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_femtograms_per_deciliter(double value)
        {
            return Density(value, DensityUnit::FemtogramsPerDeciliter);
        }


        [[nodiscard]] constexpr double picograms_per_deciliter() const
        {
            return convert_from_base(DensityUnit::PicogramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_picograms_per_deciliter(double value)
        {
            return Density(value, DensityUnit::PicogramsPerDeciliter);
        }


        [[nodiscard]] constexpr double nanograms_per_deciliter() const
        {
            return convert_from_base(DensityUnit::NanogramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_nanograms_per_deciliter(double value)
        {
            return Density(value, DensityUnit::NanogramsPerDeciliter);
        }


        [[nodiscard]] constexpr double micrograms_per_deciliter() const
        {
            return convert_from_base(DensityUnit::MicrogramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_micrograms_per_deciliter(double value)
        {
            return Density(value, DensityUnit::MicrogramsPerDeciliter);
        }


        [[nodiscard]] constexpr double milligrams_per_deciliter() const
        {
            return convert_from_base(DensityUnit::MilligramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_milligrams_per_deciliter(double value)
        {
            return Density(value, DensityUnit::MilligramsPerDeciliter);
        }


        [[nodiscard]] constexpr double centigrams_per_deciliter() const
        {
            return convert_from_base(DensityUnit::CentigramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_centigrams_per_deciliter(double value)
        {
            return Density(value, DensityUnit::CentigramsPerDeciliter);
        }


        [[nodiscard]] constexpr double decigrams_per_deciliter() const
        {
            return convert_from_base(DensityUnit::DecigramsPerDeciliter);
        }

        [[nodiscard]] static constexpr Density from_decigrams_per_deciliter(double value)
        {
            return Density(value, DensityUnit::DecigramsPerDeciliter);
        }


        [[nodiscard]] constexpr double grams_per_milliliter() const
        {
            return convert_from_base(DensityUnit::GramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_grams_per_milliliter(double value)
        {
            return Density(value, DensityUnit::GramsPerMilliliter);
        }


        [[nodiscard]] constexpr double femtograms_per_milliliter() const
        {
            return convert_from_base(DensityUnit::FemtogramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_femtograms_per_milliliter(double value)
        {
            return Density(value, DensityUnit::FemtogramsPerMilliliter);
        }


        [[nodiscard]] constexpr double picograms_per_milliliter() const
        {
            return convert_from_base(DensityUnit::PicogramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_picograms_per_milliliter(double value)
        {
            return Density(value, DensityUnit::PicogramsPerMilliliter);
        }


        [[nodiscard]] constexpr double nanograms_per_milliliter() const
        {
            return convert_from_base(DensityUnit::NanogramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_nanograms_per_milliliter(double value)
        {
            return Density(value, DensityUnit::NanogramsPerMilliliter);
        }


        [[nodiscard]] constexpr double micrograms_per_milliliter() const
        {
            return convert_from_base(DensityUnit::MicrogramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_micrograms_per_milliliter(double value)
        {
            return Density(value, DensityUnit::MicrogramsPerMilliliter);
        }


        [[nodiscard]] constexpr double milligrams_per_milliliter() const
        {
            return convert_from_base(DensityUnit::MilligramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_milligrams_per_milliliter(double value)
        {
            return Density(value, DensityUnit::MilligramsPerMilliliter);
        }


        [[nodiscard]] constexpr double centigrams_per_milliliter() const
        {
            return convert_from_base(DensityUnit::CentigramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_centigrams_per_milliliter(double value)
        {
            return Density(value, DensityUnit::CentigramsPerMilliliter);
        }


        [[nodiscard]] constexpr double decigrams_per_milliliter() const
        {
            return convert_from_base(DensityUnit::DecigramsPerMilliliter);
        }

        [[nodiscard]] static constexpr Density from_decigrams_per_milliliter(double value)
        {
            return Density(value, DensityUnit::DecigramsPerMilliliter);
        }


        [[nodiscard]] constexpr double pounds_per_u_s_gallon() const
        {
            return convert_from_base(DensityUnit::PoundsPerUSGallon);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_u_s_gallon(double value)
        {
            return Density(value, DensityUnit::PoundsPerUSGallon);
        }


        [[nodiscard]] constexpr double pounds_per_imperial_gallon() const
        {
            return convert_from_base(DensityUnit::PoundsPerImperialGallon);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_imperial_gallon(double value)
        {
            return Density(value, DensityUnit::PoundsPerImperialGallon);
        }


        [[nodiscard]] constexpr double kilograms_per_liter() const
        {
            return convert_from_base(DensityUnit::KilogramsPerLiter);
        }

        [[nodiscard]] static constexpr Density from_kilograms_per_liter(double value)
        {
            return Density(value, DensityUnit::KilogramsPerLiter);
        }


        [[nodiscard]] constexpr double tonnes_per_cubic_foot() const
        {
            return convert_from_base(DensityUnit::TonnesPerCubicFoot);
        }

        [[nodiscard]] static constexpr Density from_tonnes_per_cubic_foot(double value)
        {
            return Density(value, DensityUnit::TonnesPerCubicFoot);
        }


        [[nodiscard]] constexpr double tonnes_per_cubic_inch() const
        {
            return convert_from_base(DensityUnit::TonnesPerCubicInch);
        }

        [[nodiscard]] static constexpr Density from_tonnes_per_cubic_inch(double value)
        {
            return Density(value, DensityUnit::TonnesPerCubicInch);
        }


        [[nodiscard]] constexpr double grams_per_cubic_foot() const
        {
            return convert_from_base(DensityUnit::GramsPerCubicFoot);
        }

        [[nodiscard]] static constexpr Density from_grams_per_cubic_foot(double value)
        {
            return Density(value, DensityUnit::GramsPerCubicFoot);
        }


        [[nodiscard]] constexpr double grams_per_cubic_inch() const
        {
            return convert_from_base(DensityUnit::GramsPerCubicInch);
        }

        [[nodiscard]] static constexpr Density from_grams_per_cubic_inch(double value)
        {
            return Density(value, DensityUnit::GramsPerCubicInch);
        }


        [[nodiscard]] constexpr double pounds_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::PoundsPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::PoundsPerCubicMeter);
        }


        [[nodiscard]] constexpr double pounds_per_cubic_centimeter() const
        {
            return convert_from_base(DensityUnit::PoundsPerCubicCentimeter);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_cubic_centimeter(double value)
        {
            return Density(value, DensityUnit::PoundsPerCubicCentimeter);
        }


        [[nodiscard]] constexpr double pounds_per_cubic_millimeter() const
        {
            return convert_from_base(DensityUnit::PoundsPerCubicMillimeter);
        }

        [[nodiscard]] static constexpr Density from_pounds_per_cubic_millimeter(double value)
        {
            return Density(value, DensityUnit::PoundsPerCubicMillimeter);
        }


        [[nodiscard]] constexpr double slugs_per_cubic_meter() const
        {
            return convert_from_base(DensityUnit::SlugsPerCubicMeter);
        }

        [[nodiscard]] static constexpr Density from_slugs_per_cubic_meter(double value)
        {
            return Density(value, DensityUnit::SlugsPerCubicMeter);
        }


        [[nodiscard]] constexpr double slugs_per_cubic_centimeter() const
        {
            return convert_from_base(DensityUnit::SlugsPerCubicCentimeter);
        }

        [[nodiscard]] static constexpr Density from_slugs_per_cubic_centimeter(double value)
        {
            return Density(value, DensityUnit::SlugsPerCubicCentimeter);
        }


        [[nodiscard]] constexpr double slugs_per_cubic_millimeter() const
        {
            return convert_from_base(DensityUnit::SlugsPerCubicMillimeter);
        }

        [[nodiscard]] static constexpr Density from_slugs_per_cubic_millimeter(double value)
        {
            return Density(value, DensityUnit::SlugsPerCubicMillimeter);
        }


        [[nodiscard]] constexpr double slugs_per_cubic_inch() const
        {
            return convert_from_base(DensityUnit::SlugsPerCubicInch);
        }

        [[nodiscard]] static constexpr Density from_slugs_per_cubic_inch(double value)
        {
    ...
    private:
        [[nodiscard]] static constexpr double convert_to_base(double value, DensityUnit unit)
        {
            switch (unit)
            {
            ...
            case DensityUnit::FemtogramsPerLiter:
                return (value * 1e-15) / 1;

            case DensityUnit::PicogramsPerLiter:
                return (value * 1e-12) / 1;
            ...
            case DensityUnit::CentigramsPerDeciliter:
                return (value * 1e-2) / 1e-1;

            case DensityUnit::DecigramsPerDeciliter:
                return (value * 1e-1) / 1e-1;
        ...
        [[nodiscard]] constexpr double convert_from_base(DensityUnit unit) const
        {
            switch (unit)
            {
            ...
            case DensityUnit::KilopoundsPerCubicInch:
                return (value_ * 1.6387064e-5 / 0.45359237) / 1e3;

            case DensityUnit::PoundsPerCubicFoot:
                return value_ * 0.028316846592 / 0.45359237;

            case DensityUnit::KilopoundsPerCubicFoot:
                return (value_ * 0.028316846592 / 0.45359237) / 1e3;

            case DensityUnit::PoundsPerCubicYard:
                return value_ * 0.764554857984 / 0.45359237;

            case DensityUnit::KilopoundsPerCubicYard:
                return (value_ * 0.764554857984 / 0.45359237) / 1e3;
            ...
            case DensityUnit::FemtogramsPerLiter:
                return (value_ * 1) / 1e-15;

            case DensityUnit::PicogramsPerLiter:
                return (value_ * 1) / 1e-12;

            case DensityUnit::NanogramsPerLiter:
                return (value_ * 1) / 1e-9;

            case DensityUnit::MicrogramsPerLiter:
                return (value_ * 1) / 1e-6;

            case DensityUnit::MilligramsPerLiter:
                return (value_ * 1) / 1e-3;

            case DensityUnit::CentigramsPerLiter:
                return (value_ * 1) / 1e-2;

            case DensityUnit::DecigramsPerLiter:
                return (value_ * 1) / 1e-1;

            case DensityUnit::GramsPerDeciliter:
                return value_ * 1e-1;

            case DensityUnit::FemtogramsPerDeciliter:
                return (value_ * 1e-1) / 1e-15;

            case DensityUnit::PicogramsPerDeciliter:
                return (value_ * 1e-1) / 1e-12;

            case DensityUnit::NanogramsPerDeciliter:
                return (value_ * 1e-1) / 1e-9;
            ...
            case DensityUnit::CentigramsPerDeciliter:
                return (value_ * 1e-1) / 1e-2;

            case DensityUnit::DecigramsPerDeciliter:
                return (value_ * 1e-1) / 1e-1;
