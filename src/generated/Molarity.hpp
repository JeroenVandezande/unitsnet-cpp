...
namespace unitsnet_cpp
{
    ...
    public:
            ...
            const MolarityUnit unit = MolarityUnit::MolesPerCubicMeter)
        {
            ...
            if(unit == MolarityUnit::MolesPerCubicMeter)
            {
                base_value_ = value;
    ...
    private:
        ...
        [[nodiscard]] constexpr un_scalar_t convert_from_base(const MolarityUnit unit) const
        {
            ...
            case MolarityUnit::PoundMolesPerCubicFoot:
                return base_value_ / (static_cast<un_scalar_t>(1000) * static_cast<un_scalar_t>(0.45359237) / static_cast<un_scalar_t>(0.028316846592));
